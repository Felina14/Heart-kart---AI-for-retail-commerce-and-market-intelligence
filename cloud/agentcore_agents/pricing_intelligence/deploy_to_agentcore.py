#!/usr/bin/env python3
"""Deploy Pricing Intelligence Agent to AWS Bedrock AgentCore Runtime"""
...
def main():
    ...
    print("=" * 70)
    print("💰 Deploying Pricing Intelligence Agent to AgentCore Runtime")
    print("=" * 70)
    print(f"\n📍 Region: {region}")
    print(f"📍 Account: {boto_session.client('sts').get_caller_identity()['Account']}")
    
    agentcore_runtime = Runtime()
    agent_name = "heartkart_pricing_intelligence"
