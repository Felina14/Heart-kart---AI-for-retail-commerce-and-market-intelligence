#!/usr/bin/env python3
"""Deploy Markdown Coach Agent to AWS Bedrock AgentCore Runtime"""
...
def main():
    ...
    print("=" * 70)
    print("🏷️  Deploying Markdown Coach Agent to AgentCore Runtime")
    print("=" * 70)
    print(f"\n📍 Region: {region}")
    print(f"📍 Account: {boto_session.client('sts').get_caller_identity()['Account']}")
    
    agentcore_runtime = Runtime()
    agent_name = "heartkart_markdown_coach"
